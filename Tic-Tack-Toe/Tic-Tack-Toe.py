...
def check_win(choice_list, players, player1, player2):
    ...
    elif choice_list[3] == players[player1] and choice_list[4] == players[player1] and choice_list[5] == players[
        player1]:
        is_win = True
        winning_player = player1

    elif choice_list[6] == players[player1] and choice_list[7] == players[player1] and choice_list[8] == players[
        player1]:
        is_win = True
        winning_player = player1

    elif choice_list[0] == players[player1] and choice_list[3] == players[player1] and choice_list[6] == players[
        player1]:
        is_win = True
        winning_player = player1

    elif choice_list[1] == players[player1] and choice_list[4] == players[player1] and choice_list[7] == players[
        player1]:
        is_win = True
        winning_player = player1

    elif choice_list[2] == players[player1] and choice_list[5] == players[player1] and choice_list[8] == players[
        player1]:
        is_win = True
        winning_player = player1

    elif choice_list[6] == players[player1] and choice_list[4] == players[player1] and choice_list[2] == players[
        player1]:
        is_win = True
        winning_player = player1

    elif choice_list[8] == players[player1] and choice_list[4] == players[player1] and choice_list[0] == players[
        player1]:
        is_win = True
        winning_player = player1
    ...
    elif choice_list[3] == players[player2] and choice_list[4] == players[player2] and choice_list[5] == players[
        player2]:
        is_win = True
        winning_player = player2

    elif choice_list[6] == players[player2] and choice_list[7] == players[player2] and choice_list[8] == players[
        player2]:
        is_win = True
        winning_player = player2

    elif choice_list[0] == players[player2] and choice_list[3] == players[player2] and choice_list[6] == players[
        player2]:
        is_win = True
        winning_player = player2

    elif choice_list[1] == players[player2] and choice_list[4] == players[player2] and choice_list[7] == players[
        player2]:
        is_win = True
        winning_player = player2

    elif choice_list[2] == players[player2] and choice_list[5] == players[player2] and choice_list[8] == players[
        player2]:
        is_win = True
        winning_player = player2

    elif choice_list[6] == players[player2] and choice_list[4] == players[player2] and choice_list[2] == players[
        player2]:
        is_win = True
        winning_player = player2

    elif choice_list[8] == players[player2] and choice_list[4] == players[player2] and choice_list[0] == players[
        player2]:
        is_win = True
        winning_player = player2
